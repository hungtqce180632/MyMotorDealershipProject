        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Motors_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Motors_FuelTypes_FuelTypeId",
                        column: x => x.FuelTypeId,
                        principalTable: "FuelTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Motors_TransmissionTypes_TransmissionTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MotorExtras", x => new { x.MotorId, x.ExtraId });
                    table.ForeignKey(
                        name: "FK_MotorExtras_Motors_MotorId",
                        column: x => x.MotorId,
                        principalTable: "Motors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MotorExtras_Extras_ExtraId",
                        column: x => x.ExtraId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MotorExtras_ExtraId",
                table: "MotorExtras",
                column: "ExtraId");

            migrationBuilder.CreateIndex(
                name: "IX_Motors_CategoryId",
                table: "Motors",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Motors_FuelTypeId",
                table: "Motors",
                column: "FuelTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Motors_TransmissionTypeId",
                table: "Motors",
